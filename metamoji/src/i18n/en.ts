...
export const en: Record<string, string> = {
  ...
  "教室につながっていません": "Not connected to the classroom",
  "同期し直す": "Sync again",
  ...
  // "選択" is already in the tools section — the same word, same meaning.
  "選択を解除": "Clear selection",
  "すべて選択": "Select all",
  "{count} 件を選択中": "{count} selected",
  "選択した {count} 件を完全に削除しますか?": "Permanently delete the {count} selected notes?",
  "ゴミ箱を空にする": "Empty trash",
  "ゴミ箱の {count} 件を完全に削除しますか?": "Permanently delete all {count} notes in the trash?",
  "{done} / {total} 件を処理しています…": "Working… {done} / {total}",
  "{count} 件を処理できませんでした: {error}": "{count} could not be processed: {error}",
